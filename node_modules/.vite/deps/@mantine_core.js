...
var DefaultValue = ({ value }) => (0, import_jsx_runtime202.jsx)("div", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: Array.isArray(value) ? value.map((file) => file.name).join(", ") : value?.name });
var defaultProps46 = {
...
var MultiSelect = factory((_props, ref) => {
  ...
  const values2 = _value.map((item, index5) => (0, import_jsx_runtime255.jsx)(
    Pill,
    {
...
var Pagination = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime270.jsx)(PaginationRoot, { ref, total, ...others, children: (0, import_jsx_runtime270.jsxs)(Group, { gap, children: [
    withEdges && (0, import_jsx_runtime270.jsx)(PaginationFirst, { icon: firstIcon, ...getControlProps?.("first") }),
    withControls && (0, import_jsx_runtime270.jsx)(PaginationPrevious, { icon: previousIcon, ...getControlProps?.("previous") }),
    withPages && (0, import_jsx_runtime270.jsx)(PaginationItems, { dotsIcon }),
    withControls && (0, import_jsx_runtime270.jsx)(PaginationNext, { icon: nextIcon, ...getControlProps?.("next") }),
    withEdges && (0, import_jsx_runtime270.jsx)(PaginationLast, { icon: lastIcon, ...getControlProps?.("last") })
  ] }) });
});
